...
pub struct GastSchmidtKnoscheSF;
...
impl<B: Backend> NeuralMassModel<B> for GastSchmidtKnoscheSF {
    ...
    fn dfun(state: Tensor<B, 2>, coupling: Tensor<B, 2>, params: &[f32]) -> Tensor<B, 2> {
        ...
        let result3 = crate::engine::batch_engine::dfun::gast_sf_dfun_batch::<B>(state3, coupling3, params, None);
        result3.squeeze::<2>(0)
    }
...
pub fn gast_sf_default_params() -> Vec<f32> {
    vec![1.0, 10.0, 10.0, 0.0, 2.0, 21.2132, 1.0, 1.0, 0.0]
}
