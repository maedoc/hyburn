...
pub struct ReducedWongWangExcInh;
...
impl<B: Backend> NeuralMassModel<B> for ReducedWongWangExcInh {
    ...
    fn dfun(state: Tensor<B, 2>, coupling: Tensor<B, 2>, params: &[f32]) -> Tensor<B, 2> {
        ...
        let result3 = crate::engine::batch_engine::dfun::rww_exc_inh_dfun_batch::<B>(state3, coupling3, params, None);
        result3.squeeze::<2>(0)
    }
...
pub fn rww_exc_inh_default_params() -> Vec<f32> {
    vec![
        310.0, 125.0, 0.160, 0.000641, 100.0,
        1.4, 0.15, 1.0,
        615.0, 177.0, 0.087, 0.001, 10.0,
        1.0, 0.7, 0.382, 0.0, 2.0, 0.0,
    ]
}
